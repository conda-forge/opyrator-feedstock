...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opyrator-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14952&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opyrator-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opyrator` can be installed with:

```
conda install opyrator
```

It is possible to list all of the versions of `opyrator` available on your platform with:
